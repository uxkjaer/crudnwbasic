sap.ui.define([
	...
	return BaseController.extend("agilux.zsimpletest.controller.CreateEntity", {
		...
		onSave: function () {
			...
			//Modify the content id to bind the right key
			oModel.mChangedEntities[this.getView().getBindingContext().getPath().substring(1)].__metadata.created.headers["content-ID"] = this.getView().getBindingContext().getProperty('Id')
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("headerSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("headerSet", oData);
